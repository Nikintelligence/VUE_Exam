...
<div class="autorazation">
  <vee-form :validation-schema="rules" @submit="sendData" class="col-10 form">
    <div>
    ...
    <p class="complete hide"><b>Autorization success</b></p>
    <p class="fail hide"><b>Autorization error</b></p>
  </vee-form>
</div>
</template>
